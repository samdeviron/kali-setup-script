...
install_essentials() {
   ...
   apt install vim build-essential apt-transport-https axel libsasl2-dev seclists gobuster python2-dev libldap2-dev libssl-dev kali-desktop-gnome terminator flameshot linux-headers-$(uname -r) xclip -y
