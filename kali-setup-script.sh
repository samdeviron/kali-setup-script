...
apt install vim build-essential apt-transport-https axel libsasl2-dev python2-dev libldap2-dev libssl-dev kali-desktop-gnome terminator flameshot linux-headers-$(uname -r) -y
